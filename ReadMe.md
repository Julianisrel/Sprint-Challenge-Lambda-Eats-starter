...
useRouteMatch is used for route tags to get access to it's match data.
2. How would you explain form validation to someone who has never programmed before?
Form validation is when you go to enter an email when you sign up for something and it tells you that it is not an email if you must have the correct input.

3. In 1-2 sentences, define end to end testing.
 end-to-end testing covers as much of your apps functionality as it can. This includes all stages of the application.
